...
- 氏名のふりがながローマ字（例: TANAKA TARO）で記載されている場合は、カタカナに変換して lastNameKana・firstNameKana に入れてください。
- ふりがな（カナ・ローマ字）が名刺に記載されていない場合は、漢字の氏名から一般的な読みを推測してカタカナで lastNameKana・firstNameKana に入れてください。推測の場合は confidence を 40 にしてください。
